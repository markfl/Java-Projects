...
public class MainFrame extends JFrame {
		...
		toolBar.setToolbarListener(new ToolbarListener() {
			public void saveEventOccured() {
				...
				try {
					...
					JOptionPane.showMessageDialog(MainFrame.this, "Connot save to database",
							"Database Connection Problem", JOptionPane.ERROR_MESSAGE);
				}
			}
	...
	private void connect() {
		try {
			...
			JOptionPane.showMessageDialog(MainFrame.this, "Connot connect to database", "Database Connection Problem",
		...
		exitItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				int action = JOptionPane.showConfirmDialog(MainFrame.this,
						"Do you really wont to exit the application?", "Confirm Exit", JOptionPane.OK_CANCEL_OPTION);
	...
	private void refresh() {
		...
		try {
			...
			JOptionPane.showMessageDialog(MainFrame.this, "Connot connect to database",
					"Database Connection Problem", JOptionPane.ERROR_MESSAGE);
		}
